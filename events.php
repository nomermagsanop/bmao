...
<?php }unset($_SESSION['success']) ?>
                        ...
                        <div class="col-xl-12 col-lg-8">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h4 class="m-0 font-weight-bold text-primary">Farmers Send SMS</h4>
                                  
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="table-responsive">
                                       <form id="farmer_brgy_filter" class="mb-3" action="events.php" method="GET">
                                        ...
                                        if ($brgy == "") {
                                            $display_farmers = "SELECT * FROM farmers WHERE status = '$status'";
                                        } else {
                                            $display_farmers = "SELECT * FROM farmers WHERE brgy LIKE '$brgy' AND status = '$status'";
                                        }
                                                ...
                                                <td>
                                                    <div class='form-check'>
                                                        <form action="send_sms.php" id="smsForm">
                                                           ...
                                                           <input class="form-check-input sms-checkbox" type="checkbox"  
    value="<?php echo $contact . ' ' . $emergency_contact; ?>" 
    name="inputSMS[]" 
    data-id="<?php echo $farmer_id; ?>"
    ...
    data-land-size="<?php echo $land_size; ?>"
>
                                    ...
                                    <h4 class="m-0 font-weight-bold text-primary"></h4><button class="btn btn-success float-right" type="button" id="externalSendButton" >Send Message</button>                             
                                          </div>                               
                                    </div>                                    
                                </div>
                            </div>
